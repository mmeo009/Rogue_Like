...
public class SphericalCamera : MonoBehaviour
{
    ...
    public float mouseSensitivity = 1000.0f;             // 마우스 감도
    ...
    private void HandleInput()
    {
        ...
        currentVerticalAngle = Mathf.Clamp(currentVerticalAngle, minYAngle, maxYAngle);         // 최대 최소 값으로 수직 이동을 닫는다.
    ...
    {
        float verticalAngleRadians = currentVerticalAngle * Mathf.Deg2Rad;                          // 각도를 라디안 변환
